...
if (length(which(complete_rate < 1 & complete_rate > 0.95)) != 0L){
  cat("**Warning: There exist model variable(s) with <5% missing values. We assume a random missing pattern and apply a missing values imputation technique (FIML). **")
  indic_missings <- TRUE
